...
*/
    ...
    */
    @RequestMapping(value = "android/listforecasts", method = RequestMethod.GET)
    public ArrayList<String[]> forecastsList(HttpSession session){
        ...
        //return gson.toJson(listForecasts);
...
*/
    @RequestMapping(value = "android/updateforecast", method = RequestMethod.GET)
